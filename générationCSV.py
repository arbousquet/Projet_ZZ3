...
#
for i in range(0,15):
    fichier=open(".\\Data\\autre\\FauxPositif_"+str(i)+".csv","a")
    
    
    fichier.write(str( "TimeStamp;x;y;z\n") )
    
    for j in range(0,600):
        fichier.write("0;"+str( randint(-2300,2300) )+";"+str( randint(-2300,2300) )+";"+str( randint(-2300,2300) )+"\n")
